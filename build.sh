...
# MY_DEFAULT_ARGS="--compile-libs pylibraft libraft tests --limit-tests=MATRIX_TEST;NEIGHBORS_TEST raft-dask"
# MY_DEFAULT_ARGS_NUM=6


MY_DEFAULT_ARGS="-n --compile-lib tests --limit-tests=NEIGHBORS_TEST bench-prims --limit-bench-prims=NEIGHBORS_BENCH bench-ann"
MY_DEFAULT_ARGS_NUM=7

# MY_DEFAULT_ARGS="-n --compile-lib tests --limit-tests=NEIGHBORS_TEST"
# MY_DEFAULT_ARGS_NUM=4

# MY_DEFAULT_ARGS="-n --compile-lib bench-prims --limit-bench-prims=NEIGHBORS_BENCH"
# MY_DEFAULT_ARGS_NUM=4
...
ANN_BENCH_TARGETS="RAFT_IVF_PQ_ANN_BENCH"
